...
//data here is in JSON
const contacts = [
    {id: 1, name: "Khairul Adnan", phone: "0106645763"},
    {id: 2, name: "Anwar Nasir", phone: "0106645795"},
    {id: 3, name: "Xin Ying", phone: "999"}
]

router.get('/', (req,res) => {
    res.render('contact/contacts', {
        title: "My Contact List",
        content: 'Manage & View Details of Coantact',
        contacts
    })
});
